type BadgeTone = 'accent' | 'success' | 'error' | 'neutral';
const tones: Record<BadgeTone, string> = { accent: 'bg-accent/10 text-accent', success: 'bg-success/10 text-success', error: 'bg-error/10 text-error', neutral: 'bg-primary/10 text-primary' };
